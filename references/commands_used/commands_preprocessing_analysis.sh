...
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=0.9   data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=0.925 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=0.95  data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=0.975 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0   data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.025 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.05  data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.10 DV=1.075 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.10 DV=1.10  data_preprocess

# --- Multiple boxes --- #
# Run all at the same time for 32 cores
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=1 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=2 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=3 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=4 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=5 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=6 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=7 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 HOD_N=8 data_preprocess

# --- Different CLF Scatter Values --- #
# Run all at the same time for `32` cores
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.10 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.12 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.14 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.15 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.16 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.18 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.20 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.15 DV=1.0 SIGMA_CLF_C=0.22 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.10 DV=1.0 SIGMA_CLF_C=0.24 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.10 DV=1.0 SIGMA_CLF_C=0.25 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.10 DV=1.0 SIGMA_CLF_C=0.26 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.10 DV=1.0 SIGMA_CLF_C=0.28 data_preprocess
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.20 DV=1.0 SIGMA_CLF_C=0.30 data_preprocess

# --- Total Sample for DV=1.0 and HOD_N = 0 --- #
# Run it separately
make HALOTYPE="so" N_FEAT_USE="all" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.80 DV=1.0 HOD_N=0 data_preprocess
make HALOTYPE="so" N_FEAT_USE="sub" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_MASTER="False" REMOVE_FILES="False" CPU_FRAC=0.80 DV=1.0 HOD_N=0 data_preprocess
...
make HALOTYPE="so" N_FEAT_USE="sub" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_FILES="False" CPU_FRAC=0.75 DV=1.0 HOD_N=0 ML_ANALYSIS="hod_dv_fixed" SAMPLE_METHOD="binning" BIN_VAL="nbins" ml_analysis
...
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_FILES="False" CPU_FRAC=0.75 DV=1.0 HOD_N=0 ML_ANALYSIS="hod_fixed" DV_MODELS_N='0.9_0.95_1.0_1.05_1.10' SAMPLE_METHOD="binning" BIN_VAL="nbins" ml_analysis

## --- Sigma_C Comparison - Same HOD ---
make HALOTYPE="so" CLF_METHOD=1 CLF_SEED=1235 DENS_CALC="False" TEST_TRAIN_OPT="boxes_n" BOX_IDX="0_3_4" REMOVE_FILES="False" CPU_FRAC=0.75 DV=1.0 HOD_N=0 ML_ANALYSIS="hod_dv_fixed_sigma_c" SIGMA_C_MOD_N='0.10_0.1417_0.20_0.30' SAMPLE_METHOD="binning" BIN_VAL="nbins" ml_analysis
