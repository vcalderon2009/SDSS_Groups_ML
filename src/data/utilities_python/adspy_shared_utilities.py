...
__copyright__  =["Copyright 2017 Victor Calderon, ADSPY Utilities"]
__email__      =['victor.calderon@vanderbilt.edu']
__maintainer__ =['Victor Calderon']
__all__        =[   'plot_decision_tree',
                    ...
                    'plot_two_class_knn']
"""
Set of functions used for ML. Taken and modified from:
    https://github.com/chinmaydas96/Applied-Machine-Learning-in-Python
"""
