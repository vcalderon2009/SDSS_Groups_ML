...
class ReadML(object):
    ...
    def feat_cols_names_dict(self, return_all=False):
        ...
        """
        # Column names
        feat_cols_names = { 'GG_r_tot':"Maximum projected radius (G)",
                            'GG_sigma_v': "Total velocity dispersion (G)",
                            'GG_mr_brightest':"Luminosity of brightest galaxy (G)",
                            'g_galtype':"Group galaxy type",
                            'GG_r_med':"Median projected radius (G)",
                            'GG_mr_ratio': "Luminosity ratio (G)",
                            'GG_logssfr': "Total specific star formation rate (G)",
                            'GG_mdyn_rmed':"Dynamical mass at median radius (G)",
                            'GG_dist_cluster':"Distance to closest cluster (G)",
                            'GG_M_r':"Total luminosity (G)",
                            'GG_rproj':"Projected rms radius (G)",
                            'GG_shape':"Shape (G)",
                            'GG_mdyn_rproj':"Dynamical mass (G)",
                            'GG_dens_10.0':"Density at 10 Mpc/h (G)",
                            'GG_dens_5.0':"Density at 5 Mpc/h (G)",
                            'GG_dens_2.0':"Density at 2 Mpc/h (G)",
                            'GG_M_group':"Abundance-matched mass (G)",
                            'GG_sigma_v_rmed':"Velocity Dispersion within rmed (G)",
                            'GG_ngals':"Richness (G)",
                            'M_r':"Absolute Magnitude",
                            'g_r':"(g-r) colour of galaxy",
                            'dist_centre_group':"Distance to Group's centre",
                            'g_brightest':"If galaxy is group's brightest galaxy",
                            'logssfr':"Specific star formation rate of the galaxy",
